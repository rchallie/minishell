...
declare -x DESKTOP_AUTOSTART_ID="1060a481bc37d709e159066738736328400000020540007"
declare -x DESKTOP_SESSION="ubuntu"
declare -x DISPLAY=":0"
declare -x GDMSESSION="ubuntu"
declare -x GNOME_DESKTOP_SESSION_ID="this-is-deprecated"
declare -x GNOME_SHELL_SESSION_MODE="ubuntu"
declare -x GNOME_TERMINAL_SCREEN="/org/gnome/Terminal/screen/dce0bcf3_999b_4818_897b_fe645421b95b"
declare -x GNOME_TERMINAL_SERVICE=":1.267"
declare -x GPG_AGENT_INFO="/run/user/1000/gnupg/S.gpg-agent:0:1"
declare -x GTK_IM_MODULE="ibus"
declare -x GTK_MODULES="gail:atk-bridge"
declare -x HOME="/home/thibault"
...
declare -x OLDPWD="/home/thibault/Desktop/minishell/minishell-tester"
declare -x PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin"
declare -x PWD="/home/thibault/Desktop/minishell"
declare -x QT4_IM_MODULE="xim"
declare -x QT_ACCESSIBILITY="1"
declare -x QT_IM_MODULE="xim"
declare -x SESSION_MANAGER="local/thibault-VirtualBox:@/tmp/.ICE-unix/2054,unix/thibault-VirtualBox:/tmp/.ICE-unix/2054"
declare -x SHELL="/bin/bash"
declare -x SHLVL="2"
declare -x SSH_AGENT_PID="2190"
declare -x SSH_AUTH_SOCK="/run/user/1000/keyring/ssh"
declare -x TERM="xterm-256color"
declare -x TEXTDOMAIN="im-config"
declare -x TEXTDOMAINDIR="/usr/share/locale/"
declare -x USER="thibault"
declare -x USERNAME="thibault"
